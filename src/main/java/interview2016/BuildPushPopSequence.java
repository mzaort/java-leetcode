...
public class BuildPushPopSequence {
	...
	public List<String> convert3(String frm, String to){
		if(frm != null && to != null && frm.length() == to.length()){
			return convert3(frm, 0, to, 0, frm.length());
		}
	...
	private void convert(List<String> list, StringBuilder stringBuilder, String frm, int i, String to, int j, LinkedList<Character> stack) {
		if (i >= frm.length()) {
