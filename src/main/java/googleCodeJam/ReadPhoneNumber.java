...
public class ReadPhoneNumber {
	public static final String[] digits = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight",
			"nine" };
	public static final String[] cnts = { "", "", "double", "triple", "quadruple", "quintuple", "sextuple", "septuple",
