...
public class ValidPalindrome {
	public static void main(String[] args) {
		...
		System.out.println(vp.isPalindrome(".;7QeZh Gs:1\"?OU!rx'vm5xX17t8`'KuP:eqBw,: dt7 8d1'E'RrZ D`?2,50a28Fym`iu9v9y`d5:ZN1WQ\"5e:'Q1,a1rE':75;u0L;X.lP444R!g'BoW0x;`ID0,Ry3U2Lfz;0!U.;k: R:\"p!udZ'c,BNXi WY\"kkE`L `WNW` L`Ekk\"YW iXNB,c'Zdu!p\":R :k;.U!0;zfL2U3yR,0DI`;x0WoB'g!R444Pl.X;L0u;57:'Er1a,1Q':e5\"QW1NZ:5d`y9v9ui`myF82a05,2?`D ZrR'E'1d8 7td;:,wBqe:PuK'`8t71Xx5mv'xr!UO?\"1:sG hZeQ7 ."));
	}
