...
public class WordBreakII {
	...
	private void wordBreak(List<String> res, ArrayList<String> list, String s, int i,
			Set<String> dict) {
		if(i == s.length()){
	...
	public List<String> wordBreak2(String s, Set<String> dict) {
		int max = 0;
        for(String e : dict) if(max < e.length()) max = e.length();
	...
	public List<String> wordBreak3(String s, Set<String> dict) {
		...
		for(int i = 0; i < s.length() + 1; i++) f.add(null);
