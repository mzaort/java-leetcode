...
public class PalindromePartitioning {
	...
	private List<List<String>> partition(String s, int i, Map<Integer, List<List<String>>> map) {
	...
	private void dfs(List<List<String>> res, ArrayList<String> list, String s, int i) {
		if (i == s.length()) {
